-- ============================================================================
-- Pesquisa: aplica as regras de ignorar (crawler_ignore_rules ativas) aos
-- eventos JÁ capturados (retroativo). Mesma semântica do scraper:
--   - normaliza (minúsculas, sem acento, separadores -_<espaço> -> espaço)
--   - match por palavra inteira (\y ... \y)
--   - só afeta eventos ainda não ignorados e não promovidos ao CRM
-- Retorna a quantidade de eventos marcados como ignorados.
-- ============================================================================
