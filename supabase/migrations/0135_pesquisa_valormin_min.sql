-- ============================================================================
-- Pesquisa — filtro "Valor mín." em Organizadores e Locais passa a exigir que
-- TODA a faixa de preço esteja acima do valor: o ingresso mais barato (mínimo
-- agregado) e o mais caro (máximo agregado) >= p_valor_min. Como min <= max,
-- basta exigir o mínimo agregado >= p_valor_min.
-- (Antes exigia só max(...) >= p_valor_min — bastava 1 evento acima.)
-- ============================================================================
...
grant execute on function crawled_locals(text, numeric, text) to authenticated;
