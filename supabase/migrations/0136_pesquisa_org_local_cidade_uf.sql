-- ============================================================================
-- Organizadores e Locais (Pesquisa): filtro por cidade e por estado (UF).
--   p_cidade -> nome da cidade (igualdade exata; null = todas)
--   p_uf     -> UF (igualdade exata; null = todas)
-- Filtra os eventos ANTES da agregação (igual ao p_fonte): o organizador/local
-- aparece se tiver ao menos um evento na cidade/UF, com stats daquela cidade/UF.
-- ============================================================================

drop function if exists crawled_organizers(text, numeric, text);
drop function if exists crawled_locals(text, numeric, text);
...
grant execute on function crawled_organizers(text, numeric, text, text, text) to authenticated;
...
grant execute on function crawled_locals(text, numeric, text, text, text) to authenticated;
